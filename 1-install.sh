...
PRODUCT="Red Hat Process Automation Manager 7.4.1 on EAP7.2"

RHPAM_BC=rhpam-7.4.1-business-central-eap7-deployable
RHPAM_KS=rhpam-7.4.1-kie-server-ee8
